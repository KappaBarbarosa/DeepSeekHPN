    ...
    def _get(name):
        if name == "normal":
            ...
            return scaled_init_method_normal(
                args.init_method_std, args.layer_number, args.use_mup, args.mup_init_scale
            )
            ...
            return orthogonal_init_method(
                args.layer_number, args.use_mup, args.mup_init_scale
            )
            ...
            return wang_init_method(
                args.layer_number, args.rnn_hidden_dim, args.use_mup, args.mup_init_scale
            )
        elif name == "small_init":
            return small_init_init_method(
                args.rnn_hidden_dim, args.use_mup, args.mup_init_scale
            )
